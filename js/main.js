...
fetch(url).then((response) => response.json()).then((data) => {
    data.data.map((user) => {
        ...
        row.innerHTML = `
             ...
             <td>
                <button class='edit-button' data-id="${id}" data-name="${first_name}" data-lname="${last_name}" data-email="${email}" data-img="${avatar}">Edit</button>
             </td>
             <td>
...
form.addEventListener("submit", (e) => {
    ...
    fetch(url, {
        ...
        <td>${data.id}</td>
             ...
             <td>${data.email}</td>
             <td>
                <button class='edit-button' data-id="${data.id}" data-name="${data.first_name}" data-lname="${data.last_name}" data-email="${data.email}">Edit</button>
             </td>
             <td>
